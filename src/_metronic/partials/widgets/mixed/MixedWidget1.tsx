...
const MixedWidget1: React.FC<Props> = ({className, color}) => {
  return (
    <div className={`card ${className} bg-dark`} style={{border:'solid 1px blue'}}>
      {/* begin::Body */}
      <div className='card-body p-0'>
        {/* begin::Header */}
        <div className={`px-9 pt-7 card-rounded h-275px w-100 bg-${color}`} style={{border:'solid 1px blue'}}>
          {/* begin::Heading */}
          <div className='d-flex flex-stack'>
            <h3 className='m-0 text-white fw-bolder fs-3'>Electi</h3>
            <div className='ms-1'>
              {/* begin::Menu */}
              <button
                type='button'
